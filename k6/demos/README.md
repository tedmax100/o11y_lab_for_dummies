...
| **Ch3** | [`ch3_custom_metric_rules.js`](file:///home/nathan/Project/o11y_lab_for_dummies/k6/demos/ch3_custom_metric_rules.js) | 自訂指標的 5 個規則：最上層宣告、時間型 Trend 加 `true`、英數底線命名、帶 tags 設門檻、摘要 `CUSTOM` 區塊（不需連線） | `k6 run k6/demos/ch3_custom_metric_rules.js` |
